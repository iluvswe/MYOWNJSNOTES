...
string datatypes and gives length of a string including spaces; 
output is 20 */

console.log(sentence.indexOf("i")); 
/* A method (remember that methods usually 
comes with parentheses) gives the index location of the string element.
...
from the original entire string.  */
...
/* takes two inputs or arguments (first input is starting position, second input is ending position)
and will give the strings that includes first index and ends before last index. Output is "John is" (starts at J which is index 0 and 
...
For example, passing in " " will split it by spaces. Output is [ 'John', 'is', 'walking', 'home' ]  */
